...
namespace com.IvanMurzak.Godot.MCP.Tilemap
{
    public partial class Tool_Tilemap
    {
        ...
        public const string EditorInfoToolId = "tilemap-editor-info";
        ...
        /// tilemap-editor-info</c>), NOT by the pure-managed unit tests — a plain xUnit host
        ...
        (
            EditorInfoToolId,
            Title = "Tilemap Tools / Editor Info",
            ReadOnlyHint = true,
            IdempotentHint = true,
            OpenWorldHint = false
        )]
        [Description("Sample editor-only tool for the Tilemap Tools extension. Returns the running " +
